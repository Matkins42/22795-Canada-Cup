...
public class RobotConstants {
    ...
    //Turret constants
    public static double MANUAL_ROTATION_SPEED = 0.2;
    ...
    public static double KP = 0.004; //0.03 for 1150 motor
    public static double KI = 0.0005; //0.0005 for 1150 motor
    public static double KD = 0.0005; //12 for 1150 motor
