...
public class RobotConstants {
    ...
    public static double HOOD_CLOSE_LIMIT = 900; //mm
    public static double HOOD_FAR_LIMIT = 2000; //mm
    ...
    public static double KP = 0.6; //0.03 for 1150 motor
    public static double KI = 0.00003; //0.0005 for 1150 motor
    public static double KD = 0.033; //12 for 1150 motor-
    ...
    public static Range OUTTAKE_VELOCITY = new Range(1472, 2130); //Absolute max velocity at full power is 2380 (ticks/s)
